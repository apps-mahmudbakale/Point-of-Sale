        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('app.stations.create') }}" class="btn btn-success float-right"><i
                            ...
                            <div class="col-sm-12">
                                <table id="users" class="table table-bordered table-striped dataTable no-footer"
                                    ...
                                    <tbody>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <a href="{{route('app.stations.edit', $station->id)}}" class="btn btn-info btn-sm">
                                                        <i class="fa fa-edit"></i></a>
                                                        <button class="btn btn-danger btn-sm" id="del{{ $station->id }}"
                                                            data-value="{{ $station->id }}"><i class="fa fa-trash"></i></button>
                                                        <script>
                                                            document.querySelector('#del{{ $station->id }}').addEventListener('click', function(e) {
                                                        ...
                                                        <form id="del#{{ $station->id }}"
                                                            action="{{ route('app.stations.destroy', $station->id) }}" method="POST"
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-5">
                                <div class="dataTables_info" id="users_info" role="status" aria-live="polite">Showing <b>{{ $stations->firstItem() }}</b> to
                                    <b>{{ $stations->lastItem() }}</b> out of <b>{{ $stations->total() }}</b> entries</div>
                            </div>
