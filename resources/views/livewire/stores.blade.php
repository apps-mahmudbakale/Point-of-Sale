        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('app.stores.create') }}" class="btn btn-success float-right"><i
                    ...
                    <div id="users_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                            ...
                            <div class="col-sm-12">
                                <table id="users" class="table table-bordered table-striped dataTable no-footer"
                                    ...
                                    <tbody>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <a href="{{route('app.stores.edit', $store->id)}}" class="btn btn-info btn-sm">
                                                        <i class="fa fa-edit"></i></a>
                                                        <button class="btn btn-danger btn-sm" id="del{{ $store->id }}"
                                                            data-value="{{ $store->id }}"><i class="fa fa-trash"></i></button>
                                                        <script>
                                                            document.querySelector('#del{{ $store->id }}').addEventListener('click', function(e) {
                                                        ...
                                                        <form id="del#{{ $store->id }}"
                                                            action="{{ route('app.stores.destroy', $store->id) }}" method="POST"
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-5">
                                <div class="dataTables_info" id="users_info" role="status" aria-live="polite">Showing <b>{{ $stores->firstItem() }}</b> to
                                    <b>{{ $stores->lastItem() }}</b> out of <b>{{ $stores->total() }}</b> entries</div>
                            </div>
