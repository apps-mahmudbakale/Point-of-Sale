        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('app.requests.create') }}" class="btn btn-success float-right"><i
                    ...
                    <div id="users_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                        ...
                        {{-- <div class="row">
                            <div class="col-sm-12 col-md-5">
                                <div class="dataTables_info" id="users_info" role="status" aria-live="polite">Showing <b>{{ $requests->firstItem() }}</b> to
                                    <b>{{ $requests->lastItem() }}</b> out of <b>{{ $requests->total() }}</b> entries</div>
                            </div>
